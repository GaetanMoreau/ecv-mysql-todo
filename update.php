...
if (isset($_POST['submit']) && !empty($_POST['name'])) {
    $sql = "UPDATE todo SET name = ?, content = ? WHERE id = ?";
...
<head>
    ...
    <title>Modification tâche - ECV - TODO LIST</title>
...
<body>
    <section>
        <div class="container">
            ...
            <div class="prelist">
                <p class="prelist__tasks">Modification de la tâche <?= $_GET['id'] ?></p>
            ...
            <div class="todolist">
                <form method="POST" class="create__form">
                    <label for="name">Name
                        <input type="text" id="name" name="name" value="<?= $_GET['name'] ?>"></label>

                    <label for="content">Content
                        <input type="text" id="content" name="content" value="<?= $_GET['content'] ?>"></label>
